...
#define SERVO_MAX_PULSE_US       1944U
#define SERVO_MAX_ANGLE_DEG        85U

/*
 * 机械端点标定值。第一次装机时先卸下舵盘，小步调整这两个脉宽，
 * 确认不会顶住机械限位后再装回机构。
 */
#define SERVO_RAISED_ANGLE_DEG     85U
#define SERVO_LOWERED_ANGLE_DEG     0U
#define SERVO_RAISED_PULSE_US    1944U
...
/* 直接设置脉宽，超出 1000～1944 us 的值会被钳位。 */
void Servo_SetPulseUs(uint16_t pulse_us);

/*
 * 标定后的安全范围：0°=1000us，85°=1944us，超出 0～85° 会被钳位。
 * 动作端点：LOWER=0°/1000us，RAISE=85°/1944us。
 */
